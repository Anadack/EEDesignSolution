...
def main() -> int:
    p=argparse.ArgumentParser(description='Build/run framework and generate bus_diagram report generically.')
    ...
    gen=root/'tools'/'scripts'/'generate_architecture_bus_diagram_html.py'
    ...
    run_command(cmd, root, 'Generate bus_diagram HTML')
    return 0
