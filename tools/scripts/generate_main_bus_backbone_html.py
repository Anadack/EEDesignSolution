...
def main() -> int:
    p=argparse.ArgumentParser(description='Build/run framework and generate bus_backbone report generically.')
    ...
    gen=root/'tools'/'scripts'/'generate_architecture_bus_backbone_html.py'
    ...
    run_command(cmd, root, 'Generate bus_backbone HTML')
    return 0
