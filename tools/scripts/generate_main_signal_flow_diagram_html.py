...
def main() -> int:
    p=argparse.ArgumentParser(description='Build/run framework and generate signal_flow report generically.')
    ...
    gen=root/'tools'/'scripts'/'generate_architecture_signal_flow_html.py'
    ...
    run_command(cmd, root, 'Generate signal_flow HTML')
    return 0
