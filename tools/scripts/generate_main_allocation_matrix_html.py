...
def main() -> int:
    p=argparse.ArgumentParser(description='Build/run framework and generate allocation_matrix report generically.')
    ...
    gen=root/'tools'/'scripts'/'generate_architecture_allocation_matrix_html.py'
    ...
    run_command(cmd, root, 'Generate allocation_matrix HTML')
    return 0
