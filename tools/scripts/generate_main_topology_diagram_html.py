...
def main() -> int:
    p=argparse.ArgumentParser(description='Build/run framework and generate topology report generically.')
    ...
    gen=root/'tools'/'scripts'/'generate_architecture_topology_html.py'
    ...
    run_command(cmd, root, 'Generate topology HTML')
    return 0
